    ...
    def render(self):
        ...
        return h(
            ...
            h(
                "p",
                {},
                f"Total: {len(self.names.get())} | Starts with A: {self.starts_with_a.get()}",
            ),
            h(
                "div",
                {},
                h(
                    "button",
                    {"on_click": getattr(self, "_add_ada", lambda e: None)},
                    "+ Ada",
                ),
                h(
                    "button",
                    {"on_click": getattr(self, "_add_alan", lambda e: None)},
                    "+ Alan",
                ),
                h(
                    "button",
                    {"on_click": getattr(self, "_clear", lambda e: None)},
                    "Clear",
                ),
            ),
            h("ul", {}, items),
